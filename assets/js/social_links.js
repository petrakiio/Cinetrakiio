  ...
  const links = [
    {
      ...
      img: '../../assets/img/redes-sociais/instagran.png',
      alt: 'instagram',
    },
    {
      href: 'https://www.tiktok.com/@petrakiio',
      img: '../../assets/img/redes-sociais/tik tok.webp',
      alt: 'tiktok',
    },
    {
      href: 'https://discord.com/discovery/quests#1333839522189938740',
      img: '../../assets/img/redes-sociais/discord.png',
      alt: 'discord',
    },
    {
      href: 'https://www.linkedin.com/in/petrakiio/',
      img: '../../assets/img/redes-sociais/link.svg',
      alt: 'linkedin',
    },
  ];
